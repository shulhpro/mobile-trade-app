...
async function selectCompany(companyId) {
  ...
  if (currentTask) {
    taskInfo = `
      <div class="task-info" style="margin-top: 10px; padding: 10px; background: #e3f2fd; border-radius: 8px;">
...
async function submitVisit(closeVisit = false) {
