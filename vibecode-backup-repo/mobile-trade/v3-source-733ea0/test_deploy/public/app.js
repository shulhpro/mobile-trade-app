    ...
    return `
      <div class="product-item">
        ...
        <div class="quantity-control">
          <button type="button" class="qty-btn" onclick="updateQty(${product.id || product.ID}, -1, ${price})">в€’</button>
...
document.getElementById('visitForm')?.addEventListener('submit', async (e) => {
  ...
  formData.append('subject', 'Р’РёР·РёС‚ С‚РѕСЂРіРѕРІРѕРіРѕ РїСЂРµРґСЃС‚Р°РІРёС‚РµР»СЏ');
  ...
  try {
    ...
    const data = await response.json();
    if (data.result) {
      showSuccess('Р’РёР·РёС‚ СЃРѕС…СЂР°РЅРµРЅ!', 'Р’СЃРµ РґР°РЅРЅС‹Рµ СЃРѕС…СЂР°РЅРµРЅС‹ РІ РѕРґРЅРѕ РґРµР»Рѕ СЃ РѕС‚РјРµС‚РєРѕР№ "Р’С‹РїРѕР»РЅРµРЅРѕ"');
    } else {
